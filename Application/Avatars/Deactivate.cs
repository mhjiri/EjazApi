...
namespace Application.Avatars
{
    public class Deactivate
    {
        ...
        public class Handler : IRequestHandler<Command, Result<Unit>>
        {
            ...
            {
                var avatar = await _ctx.Avatars.FindAsync(new object[] { req.Id }, cancellationToken: cancellationToken);
                ...
                if (!result) return Result<Unit>.Failure("Failed to deactivate Avatar");
