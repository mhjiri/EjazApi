...
namespace Persistence.Migrations
{
    ...
    [Migration("20230528145123_InitialMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.CustomerCategory", b =>
                {
                    ...
                    b.HasIndex("CsCt_Creator");

                    b.HasIndex("CsCt_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerGenre", b =>
                {
                    ...
                    b.HasIndex("CsGn_Creator");

                    b.HasIndex("CsGn_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerGroup", b =>
                {
                    ...
                    b.HasIndex("CsGr_Creator");

                    b.HasIndex("CsGr_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerReward", b =>
                {
                    ...
                    b.HasIndex("CsRw_Creator");

                    b.HasIndex("CsRw_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerTag", b =>
                {
                    ...
                    b.HasIndex("CsTg_Creator");

                    b.HasIndex("CsTg_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerThematicArea", b =>
                {
                    ...
                    b.HasKey("Cs_ID", "Th_ID");

                    b.HasIndex("CsTh_Creator");

                    b.HasIndex("CsTh_Modifier");
            ...
            modelBuilder.Entity("Domain.BannerBannerLocation", b =>
                {
                    b.HasOne("Domain.BannerLocation", "Location")
                        .WithMany("Banners")
                        .HasForeignKey("Bl_ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.CustomerCategory", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsCt_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsCt_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerGenre", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsGn_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsGn_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerGroup", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsGr_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsGr_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerReward", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsRw_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsRw_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerTag", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsTg_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsTg_Modifier");
            ...
            modelBuilder.Entity("Domain.CustomerThematicArea", b =>
                {
                    b.HasOne("Domain.AppUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CsTh_Creator");

                    b.HasOne("Domain.AppUser", "Modifier")
                        .WithMany()
                        .HasForeignKey("CsTh_Modifier");
